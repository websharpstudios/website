/**handles:websharpresources-navigation**/
!(function () {
  var e,
    a,
    t,
    ...
    n,
    i,
    e = document.getElementById('site-navigation');
  if (e && void 0 !== (a = e.getElementsByTagName('button')[0]))
    if (void 0 !== (t = e.getElementsByTagName('ul')[0])) {
      for (
        ...
        s[n].addEventListener('focus', l, !0),
          s[n].addEventListener('blur', l, !0);
      !(function (e) {
        var a,
          t,
            ...
            a = function (e) {
              ...
              if (a.classList.contains('focus')) a.classList.remove('focus');
                ...
                for (
                  ...
                  t < a.parentNode.children.length;
                  ++t
                )
                  a !== a.parentNode.children[t] &&
                    a.parentNode.children[t].classList.remove('focus');
