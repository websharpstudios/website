...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PUTListsListIDItemsRequest : IEquatable<PUTListsListIDItemsRequest>
    {
        /// <summary>
        /// You can use any sort of [criteria](#section/Understanding-Criteria) to determine             what properties to add to a list, but the most common case is to use the RadarID criterion to add properties             by id.
        /// </summary>
        /// <value>You can use any sort of [criteria](#section/Understanding-Criteria) to determine             what properties to add to a list, but the most common case is to use the RadarID criterion to add properties             by id.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PUTListsListIDItemsRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PUTListsListIDItemsRequest)obj);
        }

        /// <summary>
        /// Returns true if PUTListsListIDItemsRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTListsListIDItemsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTListsListIDItemsRequest other)
        {
        ...
        public static bool operator ==(PUTListsListIDItemsRequest left, PUTListsListIDItemsRequest right)
        {
