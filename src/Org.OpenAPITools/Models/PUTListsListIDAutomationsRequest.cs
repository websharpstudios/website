...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class PUTListsListIDAutomationsRequest : IEquatable<PUTListsListIDAutomationsRequest>
    {
        ...
        /// </summary>
        /// <value>This is the DirectMailOrderID to add the properties to.</value>
        [DataMember(Name="DirectMailOrderID", EmitDefaultValue=false)]
        public string DirectMailOrderID { get; set; }
        ...
        /// </summary>
        /// <value>Set the ListIDs to which properties will be removed when they trigger this alert.  Must not be the same list as triggers the alert</value>
        [DataMember(Name="RemoveFromLists", EmitDefaultValue=false)]
        public string RemoveFromLists { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PUTListsListIDAutomationsRequest {\n");
            ...
            sb.Append("  DirectMailOrderID: ").Append(DirectMailOrderID).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PUTListsListIDAutomationsRequest)obj);
        }

        /// <summary>
        /// Returns true if PUTListsListIDAutomationsRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of PUTListsListIDAutomationsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTListsListIDAutomationsRequest other)
        {
            ...
            return 
                ...
                (
                    DirectMailOrderID == other.DirectMailOrderID ||
                    DirectMailOrderID != null &&
                    DirectMailOrderID.Equals(other.DirectMailOrderID)
                ) && 
                (
                ...
                (
                    RemoveFromLists == other.RemoveFromLists ||
                    RemoveFromLists != null &&
                    RemoveFromLists.Equals(other.RemoveFromLists)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (DirectMailOrderID != null)
                    hashCode = hashCode * 59 + DirectMailOrderID.GetHashCode();
                    ...
                    hashCode = hashCode * 59 + RemoveFromLists.GetHashCode();
        ...
        public static bool operator ==(PUTListsListIDAutomationsRequest left, PUTListsListIDAutomationsRequest right)
        {
