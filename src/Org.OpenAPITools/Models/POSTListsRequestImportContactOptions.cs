...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class POSTListsRequestImportContactOptions : IEquatable<POSTListsRequestImportContactOptions>
    {
        /// <summary>
        /// If an imported person is not found at the matched property, add them as a contact (primary).
        /// </summary>
        /// <value>If an imported person is not found at the matched property, add them as a contact (primary).</value>
        [DataMember(Name="add_as_primary_contact", EmitDefaultValue=false)]
        public bool AddAsPrimaryContact { get; set; }

        /// <summary>
        /// If an imported person is found at the matched property but is not primary, set them primary.
        /// </summary>
        /// <value>If an imported person is found at the matched property but is not primary, set them primary.</value>
        [DataMember(Name="set_as_primary_contact", EmitDefaultValue=false)]
        public bool SetAsPrimaryContact { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class POSTListsRequestImportContactOptions {\n");
            sb.Append("  AddAsPrimaryContact: ").Append(AddAsPrimaryContact).Append("\n");
            sb.Append("  SetAsPrimaryContact: ").Append(SetAsPrimaryContact).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((POSTListsRequestImportContactOptions)obj);
        }

        /// <summary>
        /// Returns true if POSTListsRequestImportContactOptions instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTListsRequestImportContactOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTListsRequestImportContactOptions other)
        {
            ...
            return 
                (
                    AddAsPrimaryContact == other.AddAsPrimaryContact ||
                    
                    AddAsPrimaryContact.Equals(other.AddAsPrimaryContact)
                ) && 
                (
                    SetAsPrimaryContact == other.SetAsPrimaryContact ||
                    
                    SetAsPrimaryContact.Equals(other.SetAsPrimaryContact)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AddAsPrimaryContact.GetHashCode();
                    
                    hashCode = hashCode * 59 + SetAsPrimaryContact.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(POSTListsRequestImportContactOptions left, POSTListsRequestImportContactOptions right)
        {
