...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSuggestionsSiteAddressRequest : IEquatable<POSTSuggestionsSiteAddressRequest>
    {
        /// <summary>
        /// **Optional** Restricts the suggestions to the values compatible with the provided criteria.                                       For instance, if the criteria contains State set to Oregon, then if we are asking for City                                      suggestions, only cities within Oregon will be provided. &gt;**ℹ️ TIP -** In suggestions the Criteria object has a different purpose in the response, see the response documentation.
        /// </summary>
        /// <value>**Optional** Restricts the suggestions to the values compatible with the provided criteria.                                       For instance, if the criteria contains State set to Oregon, then if we are asking for City                                      suggestions, only cities within Oregon will be provided. &gt;**ℹ️ TIP -** In suggestions the Criteria object has a different purpose in the response, see the response documentation.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class POSTSuggestionsSiteAddressRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((POSTSuggestionsSiteAddressRequest)obj);
        }

        /// <summary>
        /// Returns true if POSTSuggestionsSiteAddressRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSuggestionsSiteAddressRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSuggestionsSiteAddressRequest other)
        {
        ...
        public static bool operator ==(POSTSuggestionsSiteAddressRequest left, POSTSuggestionsSiteAddressRequest right)
        {
