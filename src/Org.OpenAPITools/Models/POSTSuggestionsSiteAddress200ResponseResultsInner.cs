...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class POSTSuggestionsSiteAddress200ResponseResultsInner : IEquatable<POSTSuggestionsSiteAddress200ResponseResultsInner>
    {
        /// <summary>
        /// Criteria is returned to specify details for each result for use in cases where the suggested value could have duplicates nationwide.                                      For instance, looking for address suggestions, if State is not specified in the passed criteria, but City:Portland is, and the SuggestionInput is \&quot;100 Lexington\&quot;, then the                                       two address will be in Portland, ME, and Portland, OR.  The returned Criteria object will specify the City, State and ZipFive for each of the                                       addresses.&gt;**ℹ️ TIP -** In suggestions the Criteria object has a different purpose in the request, see the request documentation.
        /// </summary>
        /// <value>Criteria is returned to specify details for each result for use in cases where the suggested value could have duplicates nationwide.                                      For instance, looking for address suggestions, if State is not specified in the passed criteria, but City:Portland is, and the SuggestionInput is \&quot;100 Lexington\&quot;, then the                                       two address will be in Portland, ME, and Portland, OR.  The returned Criteria object will specify the City, State and ZipFive for each of the                                       addresses.&gt;**ℹ️ TIP -** In suggestions the Criteria object has a different purpose in the request, see the request documentation.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class POSTSuggestionsSiteAddress200ResponseResultsInner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((POSTSuggestionsSiteAddress200ResponseResultsInner)obj);
        }

        /// <summary>
        /// Returns true if POSTSuggestionsSiteAddress200ResponseResultsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTSuggestionsSiteAddress200ResponseResultsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSuggestionsSiteAddress200ResponseResultsInner other)
        {
        ...
        public static bool operator ==(POSTSuggestionsSiteAddress200ResponseResultsInner left, POSTSuggestionsSiteAddress200ResponseResultsInner right)
        {
