...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GETPropertiesRadarIDCompsSales200ResponseResultsInner : IEquatable<GETPropertiesRadarIDCompsSales200ResponseResultsInner>
    {
        /// <summary>
        ...
        [DataMember(Name="TransferValue", EmitDefaultValue=false)]
        ...
        [TypeConverter(typeof(CustomEnumConverter<TransferTypeEnum>))]
        [JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        ...
        /// <summary>
        /// The estimated value of the property divided by its square footage.
        /// </summary>
        /// <value>The estimated value of the property divided by its square footage.</value>
        [DataMember(Name="PricePerSqFt", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>The estimated value per square foot (estimated value divided by sq ft). </value>
        [DataMember(Name="ValuePerSFRaw", EmitDefaultValue=false)]
        public string ValuePerSFRaw { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETPropertiesRadarIDCompsSales200ResponseResultsInner {\n");
            ...
            sb.Append("  TransferValue: ").Append(TransferValue).Append("\n");
            sb.Append("  TransferDate: ").Append(TransferDate).Append("\n");
            sb.Append("  TransferType: ").Append(TransferType).Append("\n");
            sb.Append("  PricePerSqFt: ").Append(PricePerSqFt).Append("\n");
            sb.Append("  AVM: ").Append(AVM).Append("\n");
            sb.Append("  ValuePerSF: ").Append(ValuePerSF).Append("\n");
            sb.Append("  ValuePerSFRaw: ").Append(ValuePerSFRaw).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GETPropertiesRadarIDCompsSales200ResponseResultsInner)obj);
        }

        /// <summary>
        /// Returns true if GETPropertiesRadarIDCompsSales200ResponseResultsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of GETPropertiesRadarIDCompsSales200ResponseResultsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPropertiesRadarIDCompsSales200ResponseResultsInner other)
        {
            ...
            return 
                ...
                (
                    ...
                    TransferValue != null &&
                    TransferValue.Equals(other.TransferValue)
                ) && 
                (
                ...
                (
                    ...
                    PricePerSqFt != null &&
                    PricePerSqFt.Equals(other.PricePerSqFt)
                ) && 
                (
                    AVM == other.AVM ||
                    AVM != null &&
                ...
                (
                    ValuePerSFRaw == other.ValuePerSFRaw ||
                    ValuePerSFRaw != null &&
                    ValuePerSFRaw.Equals(other.ValuePerSFRaw)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + TransferValue.GetHashCode();
                    if (TransferDate != null)
                    hashCode = hashCode * 59 + TransferDate.GetHashCode();
                    
                    hashCode = hashCode * 59 + TransferType.GetHashCode();
                    if (PricePerSqFt != null)
                    hashCode = hashCode * 59 + PricePerSqFt.GetHashCode();
                    if (AVM != null)
                    hashCode = hashCode * 59 + AVM.GetHashCode();
                    if (ValuePerSF != null)
                    hashCode = hashCode * 59 + ValuePerSF.GetHashCode();
                    if (ValuePerSFRaw != null)
                    hashCode = hashCode * 59 + ValuePerSFRaw.GetHashCode();
        ...
        public static bool operator ==(GETPropertiesRadarIDCompsSales200ResponseResultsInner left, GETPropertiesRadarIDCompsSales200ResponseResultsInner right)
        {
