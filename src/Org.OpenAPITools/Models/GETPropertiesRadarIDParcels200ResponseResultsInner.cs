...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GETPropertiesRadarIDParcels200ResponseResultsInner : IEquatable<GETPropertiesRadarIDParcels200ResponseResultsInner>
    {
        /// <summary>
        ...
        /// <summary>
        /// A GEOJson object with the shape of the parcel or part of the parcel in case the complete parcel is made of multiple shapes.
        /// </summary>
        /// <value>A GEOJson object with the shape of the parcel or part of the parcel in case the complete parcel is made of multiple shapes.</value>
        [DataMember(Name="Boundary", EmitDefaultValue=false)]
        public List<Object> Boundary { get; set; }

        /// <summary>
        /// A GeoJSON Point representing the geometric center of the property (or center of the current shape in the case of multiple shapes in a parcel).
        /// </summary>
        /// <value>A GeoJSON Point representing the geometric center of the property (or center of the current shape in the case of multiple shapes in a parcel).</value>
        [DataMember(Name="Centroid", EmitDefaultValue=false)]
        public List<Object> Centroid { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETPropertiesRadarIDParcels200ResponseResultsInner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GETPropertiesRadarIDParcels200ResponseResultsInner)obj);
        }

        /// <summary>
        /// Returns true if GETPropertiesRadarIDParcels200ResponseResultsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of GETPropertiesRadarIDParcels200ResponseResultsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPropertiesRadarIDParcels200ResponseResultsInner other)
        {
            ...
            return 
                ...
                (
                    ...
                    Centroid != null &&
                    other.Centroid != null &&
                    Centroid.SequenceEqual(other.Centroid)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Centroid != null)
                    hashCode = hashCode * 59 + Centroid.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(GETPropertiesRadarIDParcels200ResponseResultsInner left, GETPropertiesRadarIDParcels200ResponseResultsInner right)
        {
