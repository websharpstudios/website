...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class POSTPersonsPersonKeyPhone200ResponseResultsInner : IEquatable<POSTPersonsPersonKeyPhone200ResponseResultsInner>
    {
        /// <summary>
        /// Email or Phone purchased for a person
        /// </summary>
        /// <value>Email or Phone purchased for a person</value>
        [DataMember(Name="PurchasedValue", EmitDefaultValue=false)]
        public string PurchasedValue { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class POSTPersonsPersonKeyPhone200ResponseResultsInner {\n");
            sb.Append("  PurchasedValue: ").Append(PurchasedValue).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((POSTPersonsPersonKeyPhone200ResponseResultsInner)obj);
        }

        /// <summary>
        /// Returns true if POSTPersonsPersonKeyPhone200ResponseResultsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of POSTPersonsPersonKeyPhone200ResponseResultsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPersonsPersonKeyPhone200ResponseResultsInner other)
        {
            ...
            return 
                (
                    PurchasedValue == other.PurchasedValue ||
                    PurchasedValue != null &&
                    PurchasedValue.Equals(other.PurchasedValue)
                ) && 
                (
                    Phone == other.Phone ||
                    Phone != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + PurchasedValue.GetHashCode();
                    if (Phone != null)
        ...
        public static bool operator ==(POSTPersonsPersonKeyPhone200ResponseResultsInner left, POSTPersonsPersonKeyPhone200ResponseResultsInner right)
        {
